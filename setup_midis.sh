...
sudo apt install -y git python3-pip python3-pil cython3 python3-setuptools python3-dev libpython3-dev hostapd dnsmasq

# Install Python packages
sudo pip3 install FlightRadarAPI beautifulsoup4 MLB-StatsAPI pytz requests flask --break-system-packages
